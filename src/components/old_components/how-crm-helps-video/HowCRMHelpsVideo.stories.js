...
Default.args = {
  ...
  secondaryText: (
    <>
      ...
      <br />
      <br />
      Dynamics 365 is scalable – while it continues to excel in its core areas of sales process management and finance
      it also provides exceptional marketing, service, human resource and operations applications as well that can be
      layered in to create a complete business management solution.
    </>
  ),
};

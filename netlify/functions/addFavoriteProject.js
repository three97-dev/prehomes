...
async function associateProject({ user_identification, project_contentful_id }) {
...
exports.handler = async function (event, context) {
  try {
    ...
    await db.saveProject({ user_identification, project_contentful_id });

    await associateProject({ user_identification, project_contentful_id });
